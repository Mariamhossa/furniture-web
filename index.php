...
<html lang="en">
   ...
   <body>
      ...
      <div class="page-content-product">
       ...
       $db= new DB();
       $db->get_connection();
       $data=$db->order("*","furniture_items","id desc","8");
...
?>
               ...
               <?php foreach($items as $item){ ?>
                  ...
                  <a href="productpage.php?id=<?php echo $item['id']?>">
                        <div class="box-img">
                        <img src="./admin/img/<?php echo $item['image'] ?>" width="200px" height="200px"/> 
               ...
               <?php foreach($items as $item){ ?>
                  <div>
                     <div class="prod-box">
                        <div class="prod-i">
                           <a href="productpage.php?id=<?php echo $item['id']?>">
                            <img src="./admin/img/<?php echo $item['image'] ?>"  /> 
                        </div>
                        <div class="prod-dit clearfix">
                           <div class="dit-t clearfix">
                              ...
                              <a href="productpage.php?id=<?php echo $item['id']?>">$<?php echo $item['price'] ?></a>
                           </div>

...
if(isset($_POST['add'])){
	...
	if(isset($_POST['fname']) && empty($_POST['fname'])){
		$error['ferr']="Enter your fullname";
	}else{
		$fname=$_POST['fname'];
	}
	if(isset($_POST['uname']) && empty($_POST['uname'])){
		$error['uerr']="Enter your username";
	}else{
		$uname=$_POST['uname'];
	}
  ...
  if(!filter_var($email, FILTER_VALIDATE_EMAIL)) {
    ...
    if(count($error)<=0){
         $db->insert("users","fullname, username, email, password, active, date","'$fname','$uname','$email','$password','$active', '$date'");?>
									...
									<form method="POST" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												...
												<span style="color:red;"><?php if(isset($error['ferr'])){echo $error['ferr'];} ?></span>
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="user-name" name="uname" class="form-control">
												<span style="color:red;"><?php if(isset($error['uerr'])){echo $error['uerr'];} ?></span>
											</div>
										</div>
										<div class="item form-group">

...
$number = preg_match('@[0-9]@', $password);
 $specialChar = preg_match('@[^\w]@', $password);
  ...
  if(!filter_var($email, FILTER_VALIDATE_EMAIL)) {
    ...
    if(count($error)<=0){
         $db->update("users","fullname='$fname', username='$uname', email='$email', password='$password', active='$active'","id='$id'");
									...
									<form method="POST" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" name="fname" value="<?php echo $user['fullname'] ?>" class="form-control ">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="user-name" name="uname" value="<?php echo $user['username'] ?>" class="form-control">
										...
										<div class="item form-group">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox" class="flat" name="active" value="yes"  <?php if(isset($user['active'])){
														                                                               if($user['active']=="yes"){
																														echo "checked";}}?>/>
												</label>
											</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="password" name="password" value="<?php echo $user['password'] ?>" class="form-control">

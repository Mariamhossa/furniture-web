...
<html lang="en">
   ...
   <body>
                        ...
                        <div class="login-sr">
                           <div class="login-signup">
                              <ul>
                                 ...
                                 <li><a class="custom-b" href="./admin/login.php">Sign up</a></li>
                                 <?php } ?>
                              </ul>
                           </div>
                        </div>
    ...
    include("./admin/database.php");
       ...
       $data3= $db->select("*","categories","categ_id= '$categ_id'");
       $categ=$data3->fetch(pdo::FETCH_ASSOC);
       ?>
            ...
            <div class="container">
               <div class="row">
                  <ol class="breadcrumb">
                     ...
                     <li class="active"><?php echo $categ['category_name'] ?></li>
      ...
      <div class="product-page-main">
                  ...
                  <div class="md-prod-page">
                        ...
                        <div class="page-preview">
                           <div class="preview">
                              <div class="preview-pic tab-content">
                                 <div class="tab-pane active" id="pic-1"><img src="./admin/img/<?php echo $item['image'] ?>" alt="#" /></div>
                     ...
                     <div class="description-box">
                        <div class="dex-a">
                           ...
                           <br>
                           <p>Small: <?php echo $item['small']?></p>
                           <p>Large: <?php echo $item['large']?></p>
                        </div>
                        <div class="spe-a">
                           ...
                           <ul>
                              <li class="clearfix">
                                 ...
                                 <div class="col-md-8">
                                    <p><?php if($item['small']=="not available"){
                                             if($item['large']=="not available"){
                                                echo " ";
                                             }else{
                                                echo $item['large'];}
                                    } else{echo $item['small']; } ?></p>
                                 </div>
                              </li>
                              <li class="clearfix">
                                 <div class="col-md-4">
         ...
         <?php 
             ...
             $data2=$db->other("*","furniture_items","id!='$id'&& categ_id='$categ_id'", " rand()","4" );  
                        ...
                        <div class="col-md-6">
                           <div class="small-box-c">
                              ...
                              <a href="productpage.php?id=<?php echo $row['id']?>">
                                 <img class="img-responsive" src="./admin/img/<?php echo $row['image'] ?>" alt="#" width="150px" height="150px" />
                              </div>
                              <div class="dit-t clearfix">
                                 ...
                                 <a href="productpage.php?id=<?php echo $row['id']?>" tabindex="0">$<?php echo $row['price'] ?></a>
                              </div>
                              <div class="prod-btn">
                                 <a href="#"><i class="fa fa-star" aria-hidden="true"></i> Save to wishlist</a>
                                 <a href="#"><i class="fa fa-thumbs-up" aria-hidden="true"></i> Like this</a>
      ...
      <div class="col-md-3 col-sm-12">
                  <div class="price-box-right">
                     <h4>Price</h4>
                     <h3>$<?php echo $item['price'] ?> <span>pr.peice</span></h3>
                     <p>Option</p>
